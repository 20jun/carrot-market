  ...
  return (
    <div className="grid min-h-screen gap-10 space-y-5 bg-slate-400 py-20 px-20">
      <div className="rounded-3xl bg-white p-6 shadow-xl">
        ...
        <button className="mx-auto  mt-5 w-2/4 rounded-xl bg-blue-500 p-2 text-center text-white hover:bg-teal-500 hover:text-black focus:bg-red-500 active:bg-yellow-500">
          Checkout
        </button>
      </div>
      ...
      <div className=" rounded-2xl bg-white p-10 shadow-xl">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center space-x-5">
            <button className="aspect-square w-8 items-center justify-items-center rounded-lg bg-blue-200  text-xl text-gray-500">
              -
            </button>
            <span>1</span>
            <button className="aspect-square w-8 items-center justify-items-center rounded-lg bg-blue-200  text-xl text-gray-500">
